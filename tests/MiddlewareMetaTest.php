 ...
 * config('requestlogger.fields.meta') === true
 */
class MiddlewareMetaTest extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('requestlogger.fields.meta', true);
    ...
    public function test_middleware($method, $path, $user = null, $status_code = null, $route = null, $meta = null): void
    {
        ...
        if (is_array($meta)) {
            foreach ($meta as $key => $value) {
                \Landrok\Laravel\RequestLogger\Meta::set($key, $value);
                $this->assertEquals($value, \Landrok\Laravel\RequestLogger\Meta::get($key));
            }
        }

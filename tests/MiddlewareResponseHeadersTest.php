 ...
 * config('requestlogger.fields.response_headers') === true
 */
class MiddlewareResponseHeadersTest extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('requestlogger.fields.response_headers', true);
    ...
    public function test_middleware($method, $path, $user = null, $status_code = null, $route = null, $request_headers = '[]'): void
    {
        ...
        $this->assertEquals($log->response_headers, json_encode($response->headers->all()));

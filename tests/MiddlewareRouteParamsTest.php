 ...
 * config('requestlogger.fields.route_params') === true
 */
class MiddlewareRouteParamsTest extends TestCase
{
    ...
    protected function getEnvironmentSetUp($app)
    {
        ...
        $app['config']->set('requestlogger.fields.route_params', true);
    ...
    public function test_middleware($method, $path, $user = null, $status_code = null, $route = null, $route_params = '[]'): void
    {
        if (!is_null($user)) {
            $user = $this->$user;
            Auth::login($user);
